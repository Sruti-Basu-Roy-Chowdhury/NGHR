            ...
            >
                ...
                <div className="relative z-10 w-80 max-w-xl text-left ml-20">
                    ...
                    <div className="text-left">
                        ...
                        Grading System<span className="text-red-800"> *</span>

                        </p>

                        {/* Custom Grading System Input */}
                        <div className="mt-6">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none bg-white"
                                placeholder="Enter grading system (e.g., GPA 5 scale)"
                            />
                        </div>

                        {/* Predefined Grading System Selection Buttons */}
                        <div className="grid grid-cols-2 gap-6 mt-6">
                            {["Scale 10 grading system", "Scale 4 grading system", "% Marks of 100 Minimum", "Course requires a pass"].map((option) => (
                                <button
                                    key={option}
                                    className={`min-w-[120px] px-4 py-2 text-center rounded-lg border transition-all duration-300 focus:outline-none focus:ring-2 ${
                                        gradingSystem === option ? "bg-[#05445E] text-white" : "bg-white text-[#00A7AC] border-gray-300"
                                    }`}
                                    onClick={() => setGradingSystem(option)}
                                >
                                    {option}
                                </button>
                            ))}
                        ...
                        <div className="mt-6 flex justify-between gap-8">
                            <button
                                onClick={handleBack}
                                className="w-1/2 py-2 bg-white text-[#05445E] font-semibold rounded-lg shadow-lg hover:opacity-90 transition"
                            >
                                Back
                            </button>
                            ...
                            <button
                                onClick={handleNext}
                                className="w-1/2 py-2 text-white font-semibold rounded-lg shadow-lg hover:opacity-90 transition"
