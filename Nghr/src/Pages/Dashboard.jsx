...
const Dashboard = () => {
  ...
  return (
    <div>
      <h1 className="p-6 w-[1330px] h-[83px] text-2xl font-bold text-[#05445E]">
        NGHR
      </h1>
      ...
      >
        ...
        <div className="w-full max-w-md ml-25">
          ...
          <p className="mt-1 font-poppins font-normal text-[14px] leading-[25px] tracking-[0.5%] align-middle text-[#05445E]">
            Fill in the details to create your account
          </p>

          <div className="mt-4 space-y-6">
            <div>
              <label className="block font-semibold text-[#05445E]">
                Full Name <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                placeholder="Enter your full name"
                className="w-full p-3 border rounded mt-1 bg-transparent text-gray-900"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-112 p-3 border rounded mt-1 bg-transparent text-gray-900"
              />
            </div>
            ...
            <button
              ...
              className={`w-full mt-6 p-3 rounded text-white font-semibold transition-all ${
                phone
