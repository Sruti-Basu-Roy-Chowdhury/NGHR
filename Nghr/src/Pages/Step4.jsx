        ...
        <div className="relative">
            ...
            >
                ...
                <div className="relative z-10 w-1/2 max-w-xl text-left ml-10">
                    <p className="text-xl font-semibold text-[#05445E] mb-9">Step 4 out of 5</p>
                    <p className="text-lg text-[#05445E] font-bold mb-4">
                    ...
                    <button
                        onClick={handleNext}
                        className="mt-6 w-[73%] py-3 text-white font-semibold rounded-lg shadow-lg hover:opacity-90 transition"
